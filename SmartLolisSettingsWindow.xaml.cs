...
namespace VPet.Plugin.SmartLolis
{
    public partial class SmartLolisSettingsWindow : Window
    {
        ...
        private static Dictionary<string, string> BuildRussianText() => new()
        {
            ...
            ["info_button"] = "Инфо",
            ["command_mode_hint"] = "Префиксы: /, !, cmd, command, команда, приказ",
            ["command_example_1"] = "/займись учебой",
            ["command_example_2"] = "/займись работой",
            ["command_example_3"] = "!стоп",
        ...
        private static Dictionary<string, string> BuildEnglishText() => new()
        {
            ...
            ["info_button"] = "Info",
            ["command_mode_hint"] = "Prefixes: /, !, cmd, command",
            ["command_example_1"] = "/start studying",
            ["command_example_2"] = "/start working",
            ["command_example_3"] = "!stop",
        ...
        private static Dictionary<string, string> BuildChineseText() => new()
        {
            ...
            ["info_button"] = "说明",
            ["command_mode_hint"] = "前缀: /, !, cmd, command",
            ["command_example_1"] = "/去学习",
            ["command_example_2"] = "/去工作",
            ["command_example_3"] = "!停止",
